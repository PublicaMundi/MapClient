var query = {
    ...
    // (Optional) Result format type.
    //            'json'    : A list of records is returned. Multiple geometry columns may be returned. The client may have to
    //                        shape data e.g. create a feature collection for rendering a map
    //            'geojson' : A feature collection is returned. If multiple geometry columns is selected in the fields property,
