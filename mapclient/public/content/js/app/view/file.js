define(['jquery', 'ol', 'URIjs/URI', 'shared'], function ($, ol, URI, PublicaMundi) {
    ...
    PublicaMundi.Maps.Resources.UI.FileViewFactory = PublicaMundi.Class(PublicaMundi.Maps.Resources.UI.ViewFactory, {
        ...
        build: function (options) {
            ...
            switch (PublicaMundi.Maps.Resources.UI.Views[options.viewType]) {
                case PublicaMundi.Maps.Resources.UI.Views.CREATE:
                    return new PublicaMundi.Maps.UI.FileCreateResourceView(options);
    ...
    PublicaMundi.Maps.UI.FileCreateResourceView = PublicaMundi.Class(PublicaMundi.Maps.UI.CreateResourceView, {
        initialize: function (options) {
        ...
        render: function (target) {
            ...
            content.push('<textarea name="file_link" id="file_link" data-clear-btn="true" data-mini="true">http://62.103.179.46:9595/data/kml/natura.kml</textarea>');
            content.push('</div>');
    ...
    PublicaMundi.Maps.registerViewFactory(PublicaMundi.Maps.Resources.Types.GeoJSON, PublicaMundi.Maps.Resources.UI.FileViewFactory);

    PublicaMundi.Maps.registerViewFactory(PublicaMundi.Maps.Resources.Types.KML, PublicaMundi.Maps.Resources.UI.FileViewFactory);

    PublicaMundi.Maps.registerViewFactory(PublicaMundi.Maps.Resources.Types.GML, PublicaMundi.Maps.Resources.UI.FileViewFactory);
