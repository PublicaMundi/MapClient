define(['jquery', 'ol', 'URIjs/URI', 'shared'], function ($, ol, URI, PublicaMundi) {
    ...
    PublicaMundi.Maps.Resources.UI.WfsViewBuilder = PublicaMundi.Class(PublicaMundi.Maps.Resources.UI.ViewBuilder, {
        ...
        build: function (options) {
            ...
            switch (PublicaMundi.Maps.Resources.UI.Views[options.viewType]) {
                case PublicaMundi.Maps.Resources.UI.Views.CREATE:
                    return new PublicaMundi.Maps.UI.WfsResourceConfigView(options);
    ...
    PublicaMundi.Maps.UI.WfsResourceConfigView = PublicaMundi.Class(PublicaMundi.Maps.UI.ResourceConfigView, {
        initialize: function (options) {
        ...
        render: function (target) {
            ...
            content.push('<input type="text" name="wfs_title" id="wfs_title" value="" placeholder="Resource title..." data-clear-btn="true" data-mini="true" />');
            content.push('</div>');
            content.push('<div class="ui-field-contain">');
            content.push('<label for="wfs_url" style="padding-left: 0.23em;">Endpoint</label>');
            content.push('<input type="text" name="wfs_url" id="wfs_url" value="" data-clear-btn="true" data-mini="true">');
            content.push('</div>');
            content.push('<div class="ui-field-contain">');
    ...
    PublicaMundi.Maps.registerViewBuilder(PublicaMundi.Maps.Resources.Types.WFS, PublicaMundi.Maps.Resources.UI.WfsViewBuilder);
