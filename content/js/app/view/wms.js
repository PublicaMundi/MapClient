define(['jquery', 'ol', 'URIjs/URI', 'shared'], function ($, ol, URI, PublicaMundi) {
    ...
    PublicaMundi.Maps.Resources.UI.WmsViewBuilder = PublicaMundi.Class(PublicaMundi.Maps.Resources.UI.ViewBuilder, {
        ...
        build: function (options) {
            ...
            switch (PublicaMundi.Maps.Resources.UI.Views[options.viewType]) {
                case PublicaMundi.Maps.Resources.UI.Views.CREATE:
                    return new PublicaMundi.Maps.UI.WmsResourceConfigView(options);
    ...
    PublicaMundi.Maps.UI.WmsResourceConfigView = PublicaMundi.Class(PublicaMundi.Maps.UI.ResourceConfigView, {
        initialize: function (options) {
        ...
        render: function (target) {
            ...
            content.push('<input type="text" name="wms_title" id="wms_title" value="" placeholder="Resource title..." data-clear-btn="true" data-mini="true" />');
            content.push('</div>');
            content.push('<div class="ui-field-contain">');
            content.push('<label for="wms_url" style="padding-left: 0.23em;">Endpoint</label>');
            content.push('<input type="text" name="wms_url" id="wms_url" value="" data-clear-btn="true" data-mini="true">');
            content.push('</div>');
    ...
    PublicaMundi.Maps.registerViewBuilder(PublicaMundi.Maps.Resources.Types.WMS, PublicaMundi.Maps.Resources.UI.WmsViewBuilder);
