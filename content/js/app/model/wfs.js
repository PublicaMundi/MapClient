define(['jquery', 'ol', 'URIjs/URI', 'shared'], function ($, ol, URI, PublicaMundi) {
    ...
    PublicaMundi.Maps.Resources.WfsResource = PublicaMundi.Class(PublicaMundi.Maps.Resources.Resource, {
        ...
        getMetadata: function (callback) {
            ...
            $.ajax({
                ...
                var parser = new X2JS();
                var result = parser.xml_str2json(response);
    ...
    PublicaMundi.Maps.Resources.WfsLayerBuilder = PublicaMundi.Class(PublicaMundi.Maps.Resources.LayerBuilder, {
        initialize: function (options) {
    ...
    PublicaMundi.Maps.registerResource(PublicaMundi.Maps.Resources.Types.WFS, 'WFS', PublicaMundi.Maps.Resources.WfsResource, PublicaMundi.Maps.Resources.WfsLayerBuilder);
