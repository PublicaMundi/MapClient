define(['jquery', 'ol', 'URIjs/URI', 'shared'], function ($, ol, URI, PublicaMundi) {
    ...
    PublicaMundi.Maps.Resources.GeoJsonResource = PublicaMundi.Class(PublicaMundi.Maps.Resources.FileResource, {
    ...
    PublicaMundi.Maps.registerResource(PublicaMundi.Maps.Resources.Types.GeoJSON, 'GeoJSON', PublicaMundi.Maps.Resources.GeoJsonResource, PublicaMundi.Maps.Resources.FileLayerBuilder);
